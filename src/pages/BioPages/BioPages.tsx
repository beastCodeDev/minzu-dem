...
const BioPages: React.FC = () => {
  ...
  return (
    <div className="container max-w-custom pl-custom pr-custom">
      <LanguageSwitcher />
      <section className="flex gap-12 mt-14 mr-8 mb-4 ml-8 mobile:flex-col-reverse mobile:mt-20 mobile:mb-20 justify-center">
        ...
        <div className=" w-full flex flex-col md:flex-row md:items-start md:space-x-4 h-auto">
